...
function RoleFields({
  ...
  return (
    <div style={{ display: "grid", gap: 10, gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))" }}>
      <PersonSelect label="Primary" people={people} value={value.primary} onChange={(id) => onChange({ ...value, primary: id })} />
      <PersonSelect
        label="Alternate 1"
        people={people}
                ...
                <div key={idx} style={{ display: "grid", gap: 10 }}>
                  <div style={{ display: "grid", gap: 10, gridTemplateColumns: "2fr 1fr 1fr" }}>
                    <input
                      ...
                      placeholder="Carrier (e.g., Northwestern Mutual)"
                      style={input}
                    />
                    <input
                ...
                <div key={idx} style={{ display: "grid", gap: 10 }}>
                  <div style={{ display: "grid", gap: 10, gridTemplateColumns: "2fr 1fr" }}>
                    <input
                      ...
                      placeholder="Description (e.g., 2022 Honda Accord)"
                      style={input}
                    />
                    <input
                      value={it.approxValueCents ? moneyCentsToDollars(it.approxValueCents) : ""}
            ...
            <div style={{ marginTop: 10, display: "grid", gap: 10 }}>
              ...
              <label style={{ display: "grid", gap: 6 }}>
                ...
                <textarea
                  ...
                  placeholder="Examples: jewelry, art, firearms, collectibles, safe deposit box"
                  rows={3}
                  style={{ ...input, fontFamily: "ui-sans-serif, system-ui, -apple-system", resize: "vertical" }}
                />
              </label>
